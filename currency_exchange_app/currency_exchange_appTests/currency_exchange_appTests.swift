...
final class currency_exchange_appTests: XCTestCase {
    ...
    func test_shouldShowView_true() async {
        let currencyExchange = CurrencyExchange(
            disclaimer: "disclaimer",
            license: "license",
            base: "USD",
        ...
        XCTAssertTrue(testStore.state.shouldShowView)

    }
    
    func test_shouldShowView_false() async {
        let currencyExchange = CurrencyExchange(
            disclaimer: "disclaimer",
            license: "license",
            base: "USD",
        ...
        XCTAssertTrue(testStore.state.shouldShowView == false)
